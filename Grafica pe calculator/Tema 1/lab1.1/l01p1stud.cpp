...
void Init(void) {
   ...
   // regula mainii drepte - arata fata unui desen(cum este degetul mare)
...
int main(int argc, char** argv) {
   ...
   // void glutInitWindowSize (int lungime, int latime)
   ...
   // starile initiale sunt 0 peste tot. Sau pe biti(bit mask)
   ...
   // functia callback
   // functia fara paranteze pointer/ functia cu paranteze se executa
   ...
   // scaneaza evenimente si apeleaza functiile de callback
   glutMainLoop();
